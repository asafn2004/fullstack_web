...
//     document.getElementById("s_sales").innerHTML = nextNumberSales == undefined ? "FREE" : nextNumberSales;
//     createSales();
//     setTimeout(() => {
//         clearInterval(cellBlinkSales);
//         document.getElementById("s_sales").style.visibility = "visible";
//     }, 5000)

//     var cellBlinkSales = setInterval(() => {
//         showSales = !showSales;
//         document.getElementById("s_sales").style.visibility = show ? "visible" : "hidden";
//     }, 500)
// }
...
//     document.getElementById("s_service").innerHTML = nextNumberService == undefined ? "FREE" : nextNumberService;
//     createService();
//     setTimeout(() => {
//         clearInterval(cellBlinkService);
//         document.getElementById("s_service").style.visibility = "visible";
//     }, 5000)

//     var cellBlinkService = setInterval(() => {
//         showService = !showService;
//         document.getElementById("s_service").style.visibility = show ? "visible" : "hidden";
//     }, 500)
// }
...
//     document.getElementById("s_lab").innerHTML = nextNumberLab == undefined ? "FREE" : nextNumberLab;
//     createLab();
//     setTimeout(() => {
//         clearInterval(cellBlinkLab);
//         document.getElementById("s_lab").style.visibility = "visible";
//     }, 5000)

//     var cellBlinkLab = setInterval(() => {
//         showLab = !showLab;
//         document.getElementById("s_lab").style.visibility = show ? "visible" : "hidden";
//     }, 500)
// }
